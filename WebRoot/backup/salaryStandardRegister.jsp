...
<html>
	<head>
		<html:base />
		<title>My JSP 'updateSalaryStandard.jsp' starting page</title>
	...
	<body>
		<html:form  method="post" action="/salaryStandAction?method=add" >
			<table width="100%" border="0" cellpadding="0" >
				...
				<tr>
					<td height="30" colspan="3" class="td_LR">
						登记人 ${sessionScpe.USER.userName }&nbsp;&nbsp;&nbsp;&nbsp;
						  <html:hidden property="register" value="${sessionScpe.USER.userName }"/>
							登记时间&nbsp;${date }
				...
				<tr>
					...
					<td class="td_LTE">
					       <html:text property="basicmoney"  value="0.00"></html:text>
					</td>
				</tr>
				<tr>
					<td height="30" class="td_LTR">
