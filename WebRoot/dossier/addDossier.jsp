		...
		<tr>
			<td valign="top">
				...
				<tr>
					...
					<td height="30" class="td_LTE">
						<html:select property="employeeNation">
					        ...
					        <div id="divNation" style="display:inline">
							<font color="#003300">*&nbsp;</font>
						</div>
						<div id="Layer1"
				...
				<tr>
					...
					<td class="td_LTE">
						<html:text property="employeeBirthPlace"></html:text>
				...
				<tr>
					...
					<td class="td_LTE">
						...
						<div id="divDegree" style="display:inline">
							<font color="#003300">*&nbsp;</font>
						</div>
					</td>
				</tr>
				...
				<tr>
					...
					<td class="td_LTE">
						...
						<div id="divPolity" style="display:inline">
							<font color="#003300">*&nbsp;</font>
						</div>
					</td>
				</tr>
				<tr>
					...
					<td class="td_LTE">
						...
						<div id="divPosition" style="display:inline">
							<font color="#003300">*&nbsp;</font>
						</div>
					</td>
				</tr>
				<tr>
					...
					<td class="td_LTR">
						<html:text property="employeePostcode"
							...
							<div id="divPostCode" style="display:inline"><font color="#003300">*&nbsp;</font></div>
					</td>
					<td class="td_LTR">
						爱&nbsp;&nbsp;&nbsp;&nbsp;好
					</td>
				...
				<tr>
					...
					<td colspan="3" class="td_LTE">
						<html:textarea property="employeeRemark" cols="70" rows="5"></html:textarea>
