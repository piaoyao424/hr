    ...
    <script type="text/javascript">
		...
		function locationTo(){
		   ...
		   if(pageNum.length==0){
	        ...
	        window.location.href="role.do?method=getRoleList&pageNum="+${totalPage };
	       }else{
		     window.location.href="role.do?method=getRoleList&pageNum="+pageNum;
		   }
		}
	</script>
    </head>
    ...
    <table width="100%" height="100%" border="0" cellpadding="0"
		...
		<tr>
			<td height="30" colspan="4" align="right" class="td_LTRB">
			 <bean:size name="roleList" id="count"/>
						&nbsp;共有 ${count }条记录，当前第 ${curPage }/${totalPage } 页&nbsp;&nbsp;
						<a href="../role.do?method=getRoleList&pageNum=1"><img
								src="../images/first.gif" width="37" height="15"
								align="absmiddle" border="0" /></a>&nbsp;
						<logic:notEqual value="1" name="curPage">
							<a href="../role.do?method=getRoleList&pageNum=${curPage-1 }"><img
						...
						<logic:notEqual value="${totalPage }" name="curPage">
							<a href="../role.do?method=getRoleList&pageNum=${curPage+1 }"><img
									...
									align="absmiddle" border="0" /></a>&nbsp; </logic:notEqual>
						<a href="../role.do?method=getRoleList&pageNum=${totalPage }"><img
