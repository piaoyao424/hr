...
<html:html lang="true">
  <head>
    ...
    <link rel="stylesheet" href="../js/style.css" type="text/css"></link>
     ...
     function checkNull(){
       var positionName=document.getElementById("divPositionName");
       positionName.innerHTML="";
       if(document.forms[0].positionName.value.length==0){
         positionName.innerHTML="<font color='red'>* 职位名称不能为空</font>";
         return false;
       }else{
         return true;
       }
  ...
  <body>
   <table width="100%" height="100%" border="0" cellpadding="0"
		...
		<tr>
													...
													<table width="100%" border="0" cellspacing="0"
														...
														<tr>
															...
															<td width="95%" class="STYLE1">
																<span class="STYLE3">你当前的位置</span>：数据字典管理&gt;&gt;部门职位管理&gt;&gt;添加职位
															</td>
														</tr>
													</table>
												</td>
			...
			action="/positionAction?method=addRole&branchId=${branchId}" onsubmit="return checkNull()">
			<table width="100%" height="100" border="0" cellpadding="0"
				cellspacing="0">
				<tr>
				...
				<tr>
					...
					<td width="50%" class="td_LTE">
						...
						<div id="divPositionName" style="display:inline"><font color="green">* 职位不能为空</font></div>
					</td>
				</tr>
				<tr>
